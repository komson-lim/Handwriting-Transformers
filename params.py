...
if DATASET == 'IAM':
    ...
    DATASET_PATHS = 'files/best.pickle'
    NUM_WRITERS = 6590

ENGLISH_WORDS_PATH = 'files/english_words.txt' if DATASET != 'BEST' else 'files/th.txt'
...
TN_ENC_LAYERS = 3
TN_DEC_LAYERS = 3
ALPHABET = 'Only thewigsofrcvdampbkuq.A-210xT5\'MDL,RYHJ"ISPWENj&BC93VGFKz();#:!7U64Q8?+*ZX/%' if DATASET != 'BEST' else 'กขคฆงจฉชซฌญฎฏฐฑฒณดตถทธนบปผฝพฟภมยรฤลวศษสหฬอฮฯะัาำิีึืุูเแโใไๅๆ็่้๊๋์ '
